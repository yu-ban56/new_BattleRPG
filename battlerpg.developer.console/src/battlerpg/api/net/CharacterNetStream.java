...
public class CharacterNetStream {
    ...
    public CharacterNetStream(String accessAddress) throws IOException{
        ...
        outputFilters = new ObjectOutputStream(new GZIPOutputStream(new BufferedOutputStream(outputStream)));
        inputFilters = new ObjectInputStream(new GZIPInputStream(new BufferedInputStream(inputStream)));
    }
